...
PersonService.prototype.getChildrenByPersonId = function( id ) {
    return pool.query('select id, first, last, dob from person where id in ( select child_id from person_xref where parent_id = $1 )', [id]);
}
